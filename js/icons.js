...
(function () {
  ...
  const ICONS = {
    ...
    brain: '<path d="M12 5a3 3 0 1 0-5.997.125 4 4 0 0 0-2.526 5.77 4 4 0 0 0 .556 6.588A4 4 0 1 0 12 18Z"/><path d="M12 5a3 3 0 1 1 5.997.125 4 4 0 0 1 2.526 5.77 4 4 0 0 1-.556 6.588A4 4 0 1 1 12 18Z"/><path d="M12 18v4"/><path d="M12 5v9"/>',
    flame: '<path d="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3-1.072-2.143-.224-4.054 2-6 .5 2.5 2 4.9 4 6.5 2 1.6 3 3.5 3 5.5a7 7 0 1 1-14 0c0-1.153.433-2.294 1-3a2.5 2.5 0 0 0 2.5 2.5z"/>',
    swords: '<polyline points="14.5 17.5 3 6 3 3 6 3 17.5 14.5"/><line x1="13" x2="19" y1="19" y2="13"/><line x1="16" x2="20" y1="16" y2="20"/><line x1="19" x2="21" y1="21" y2="19"/><polyline points="14.5 6.5 18 3 21 3 21 6 17.5 9.5"/><line x1="5" x2="11" y1="19" y2="13"/><line x1="4" x2="8" y1="16" y2="20"/><line x1="3" x2="5" y1="21" y2="19"/>',
    ...
    skull: '<path d="m12.5 17-.5-1-.5 1h1z"/><path d="M15 22a1 1 0 0 0 1-1v-1a2 2 0 0 0 1.56-3.25 8 8 0 1 0-11.12 0A2 2 0 0 0 8 20v1a1 1 0 0 0 1 1z"/><circle cx="9" cy="12" r="1"/><circle cx="15" cy="12" r="1"/>',
  ...
  function getIcon(name, options = {}) {
    ...
    const ariaLabel = options.ariaLabel ? ` aria-label="${options.ariaLabel}"` : ' aria-hidden="true"';
    const extraStyle = options.style ? ` style="${options.style}"` : '';
  ...
  function renderAll(root = document) {
    ...
    elements.forEach(el => {
      ...
      const strokeAttr = el.getAttribute('data-stroke');
      const fillAttr = el.getAttribute('data-fill');
      const ariaLabel = el.getAttribute('aria-label');

      const size = sizeAttr ? (SIZE_MAP[sizeAttr] || parseInt(sizeAttr, 10)) : 18;
      const strokeWidth = strokeAttr ? parseFloat(strokeAttr) : 2;
      ...
      const svg = getIcon(name, {
        ...
        strokeWidth,
        fill: fillAttr || 'none',
        className: el.className || 'lucide-icon',
        ariaLabel: ariaLabel || ''
      });
  ...
  const ApexIcons = {
    get: getIcon,
    renderAll: renderAll,
    has: (name) => Boolean(ICONS[(name || '').toLowerCase()]),
